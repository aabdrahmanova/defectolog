...
import { Carousel, Comment, Avatar, Row, Col } from 'antd';
    ...
    return (
        <div className='section feedback'>
            <Container>
                ...
                <Row>
                    <Col xs={24} sm={24} md={24} lg={{span:18, offset: 3}} xl={{span:18, offset: 3}} xxl={{span:16, offset: 4}}>
                        <Carousel 
                            autoplay
                            autoplaySpeed={5000}
                            speed={1000}
            ...
            <animated.div style={contProps} className="clouds" onMouseMove={({ clientX: x, clientY: y }) => set({ xy: calc(x, y) })}>
                        <animated.div className="clouds1" style={{ transform: props.xy.interpolate(trans1) }} />
                        <animated.div className="clouds2" style={{ transform: props.xy.interpolate(trans3) }} />
                        <animated.div className="clouds3" style={{ transform: props.xy.interpolate(trans4) }} />
                    </animated.div>
        </div>
    )
}